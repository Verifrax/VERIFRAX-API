...
The VERIFRAX Reference Verifier v2.4.0 enables independent certificate verification without requiring VERIFRAX infrastructure, services, or availability.

## Authority

This verifier is the **authoritative reference implementation** for verifying certificates issued by VERIFRAX Worker v2.4.0.
...
This matches VERIFRAX Worker verifier version 2.4.0.
